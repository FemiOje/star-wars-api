import AhsokaImage from '../assets/images/ahsoka.jpeg'
import { NavLink } from 'react-router-dom';

const Home = () => {

  const backgroundStyle = {
    backgroundImage: `url(${AhsokaImage})`,
